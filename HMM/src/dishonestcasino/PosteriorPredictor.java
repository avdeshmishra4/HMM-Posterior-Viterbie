...
public class PosteriorPredictor {
	...
	public void backwardAlgorithm(String actualSequence, String obs, HiddenMarkovModel hmm,
			BufferedWriter bw, String stateSymbols[], double[][] forwardMatrix, BufferedWriter writeAccuracy)
			throws IOException {
	...
	//		System.out.println(backwardMatrix[y][backwardMatrix[y].length - 2] = sum / 5);
		...
		printAccuracy(actualSequence, predictedSequence, bw, writeAccuracy, hmm);																		// to print accuracy of prediction call printAccuracy	
	...
	public void printAccuracy(String actualSequence, String predictedSequence,									
		...
		writeAccuracy.write("Accuracy Statistics for posterior decoding");
